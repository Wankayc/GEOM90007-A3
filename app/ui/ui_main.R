...
ui <- tagList(
  ...
  div(
    ...
    div(
      ...
      div(style = "margin: 30px 0;", icon("spinner", class = "fa-spin fa-3x", 
                                          style = "color: #036B55;")),
      ...
      header = tagList(
        ...
        tags$head(
          tags$style(HTML("
            ...
            .page-wrap h2 { color:#036B55; font-weight:700; 
            margin:10px 0 12px 0; text-align:left; }
            .card { padding:15px; background:#f8f9fa; border-radius:8px; }
            .card h4 { color:#036B55; margin-bottom:12px; font-size:15px; 
            font-weight:700; }
            .radio-scroll { max-height: 260px; overflow:auto; 
            padding-right:4px; }
            .radio-scroll .radio { margin-bottom:6px; }
            .help-note { color:#666; font-size:11px; line-height:1.3; 
